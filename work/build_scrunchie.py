...
import openpyxl
products=json.loads(Path(r"E:\mvideo\MvideoERP\work\scrunchie_input.json").read_text(encoding="utf-8"))
TPL=Path(r"E:\mvideo\MvideoERP\work\downloads\template_scrunchie.xlsx")
OUT=Path(r"E:\mvideo\MvideoERP\work\downloads\mv_upload_scrunchie_b1.xlsx")
...
def up(url,offer,k):
    ...
    obj=f"mvideo/scrunchie/{offer}/{k:02d}.jpg"
...
for n,p in enumerate(products):
    ...
    for k,u in enumerate(urls): ws.cell(r,93+k,u)
