...
JOBS=[("ковер",r"E:\mvideo\MvideoERP\work\downloads\template_carpet.xlsx"),
      ("шапка",r"E:\mvideo\MvideoERP\work\downloads\template_hat.xlsx"),
      ("чемодан",r"E:\mvideo\MvideoERP\work\downloads\template_suitcase.xlsx")]
